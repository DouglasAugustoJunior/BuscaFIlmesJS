document.getElementById('formulario').addEventListener('submit',pesquisarFilmes); // chama função de pesquisa ao clicar no botão

function pesquisarFilmes(e){
    var filmepesquisa = document.getElementById('pesquisar').value; // pega valor da caixa de texto
    buscarFilmes(filmepesquisa); // chama função de busca
    e.preventDefault();
}
